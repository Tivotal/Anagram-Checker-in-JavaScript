...
btn.addEventListener("click", () => {
  ...
  //removing spaces and punctuation from both words
  word1 = word1.replace(/[^\w]/g, "");
  word2 = word2.replace(/[^\w]/g, "");

  //comparing the lengths of both words
  ...
  //letter occurences count in both words
  let count1 = {};
  let count2 = {};
  ...
  //comparing letter count of both the words
